<div class='search-form bible-search'>
    ...
    {{ html()->form('GET', route('texts.by_bible'))->open(); }}
    ...
    @include('includes.formitem._NUMBER',
            ['name' => 'search_chapter',
             'value' => $url_args['search_chapter'] ?? '',
             'title' => trans('text.chapter'),
    ])
            ...
            <div class="col-md-6">
                ...
                @include('includes.formitem._NUMBER',
                        ['name' => 'search_verse_from',
                         ...
                         'attributes' => ['placeholder' => trans('general.from')],
                         'min' => 1,
                        ])
            </div>
            <div class="col-md-6">
                ...
                @include('includes.formitem._NUMBER',
                        ['name' => 'search_verse_to',
                         ...
                         'attributes' => ['placeholder' => trans('general.to')],
                         'min' => 1,
                        ])
            </div>
    ...
    @include('includes.formitem._CHECKBOX_styled',
            ['name' => 'with_parallel',
            'value' => 1,
            'checked' => !empty($url_args['with_parallel']) && (int)$url_args['with_parallel'] === 1,
            'tail'=>trans('text.with_parallel')])

    <div class="output-fields">    
        <div class='output-fields-e'>
            <input id="portion" name="portion" class='form-control'
